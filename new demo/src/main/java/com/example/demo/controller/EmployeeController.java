...
//		employee.setCompany(company);
	...
	public String findPage(@PathVariable("pageNumber")Integer pageNumber,@PathParam("pageSize")Integer pageSize, @PathParam("sortFiled")String sortField, @PathParam("sortDirection")String sortDirection, Model model ) {
		
		Page<Employee> page = empService.findPage(pageNumber, pageSize, sortField, sortDirection);
		
		List<Employee> res = page.getContent();
		
		model.addAttribute("listEmployeeOrdered", res);
